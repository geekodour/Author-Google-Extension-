...
function getAuthor(){
  ...
  if(host === 'amazon'){
    ...
    imageNeeded = 5;
    return document.querySelector('.subtitle').innerText.slice(1,-1).split(",").slice(1);
  }
}
...
function getTheDiv(){
  if(host === 'amazon'){
    ...
    return document.getElementsByClassName('bookDetails-wrap')[0];
  }
...
author = getAuthor()+" author"; // GETS THE AUTHOR NAME AND APPENDS "AUTHOR" TO IT
var url = 'https://www.google.co.in/search?&tbm=isch&q='+author; // PREPARES THE URL TO BE FETCHED
